...
const DefiEvolution: React.FC = () => {
  const evolutions = [
    {
      title: "DeFi 1.0",
      description: "Basic DeFi protocols enabled lending, borrowing, and simple swaps. Limited composability, high gas fees, and no automation.",
      examples: ["Uniswap V1", "Compound", "MakerDAO"],
      color: "from-gray-600 to-gray-800"
    },
    {
      title: "DeFi 2.0",
      description: "Protocols became more scalable and composable. Yield strategies matured, but users still needed to manage everything manually.",
      examples: ["Uniswap V3", "Aave", "Curve"],
      color: "from-blue-600 to-blue-800"
    },
    {
      title: "DeFi 3.0",
      description: "AI-native finance. Agents that build and manage portfolios automatically — with personalized strategies and minimal human input.",
  ...
  return (
    <section className="relative py-20 bg-slate-950">
      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10">
        ...
        {/* Bottom Callout - moved outside relative timeline */}
        <div className="mt-20 bg-gradient-to-r from-purple-900/50 to-slate-900 p-6 rounded-xl border border-purple-800/50 shadow-lg max-w-3xl mx-auto">
          ...
          <p className="text-gray-300 text-center">
            Titan AI brings DeFi 3.0 to life — replacing complex dashboards and manual trades with intelligent agents that
            manage capital on your behalf. This is the next leap in financial evolution: 24/7 automation, tailored to you.
          </p>
        </div>
      </div>
    </section>
