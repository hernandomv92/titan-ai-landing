      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10">
        <div className="text-center mb-16">
          ...
          <p className="text-gray-400 max-w-2xl mx-auto text-lg">
            Deploy autonomous AI agents that manage your crypto portfolio 24/7 with hedge fund-grade strategies
          </p>
        </div>
          ...
          <div className="space-y-8">
            ...
            <div className="space-y-6">
              <div className="flex">
                ...
                <div>
                  <h4 className="text-xl font-medium text-white mb-1">Define Your Strategy</h4>
                  <p className="text-gray-400">
                    Set your risk tolerance, investment goals, token preferences, and constraints. Your AI agent 
                    adapts to your specified parameters.
                  </p>
                </div>
              </div>
              ...
              <div className="flex">
                ...
                <div>
                  <h4 className="text-xl font-medium text-white mb-1">Deploy Your Agent</h4>
                  <p className="text-gray-400">
                    Authorize your AI agent to make decisions for your wallet. Only you maintain custody of your 
                    assets—Titan never holds your funds.
                  </p>
                </div>
              </div>
              ...
              <div className="flex">
                ...
                <div>
                  <h4 className="text-xl font-medium text-white mb-1">Earn Optimized Returns</h4>
                  <p className="text-gray-400">
                    Your agent works 24/7, analyzing market conditions, executing trades, and adjusting positions 
                    to maximize returns while respecting your risk parameters.
                  </p>
                </div>
              </div>
            </div>
